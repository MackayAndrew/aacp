...
PAYROLL_PAIRS = [
    {
        ...
        "aacp": "FETCH|HR|return:HR-Agent|p:1|aacp:1.0|res:emp_salary|period:2024-08|filter:status=active|fmt:json",
    },
    {
        ...
        "aacp": "FETCH|FIN|return:HR-Agent|p:1|aacp:1.0|res:budget_cc|period:2024-08|fmt:json",
    },
    {
        ...
        "aacp": "MERGE|HR|return:HR-Agent|p:1|aacp:1.0|rules:payroll_v2|validate:budget_cc",
    },
    {
        ...
        "english": (
            ...
            "format for distribution and Excel format for Finance. Include comparison "
            "to last month."
        ),
        "aacp": "REPORT|HR|return:HR-Agent|p:2|aacp:1.0|fmt:pdf,xlsx|highlight:REVIEW_REQ",
    },
]
